...
public class Impresora extends Activity implements OnClickListener{
/******************************************************************************************************/
	// Debugging
	...
	public void onClick(View v) {
		...
		switch (v.getId()) {
			case R.id.button_scan: {
				Intent serverIntent = new Intent(Impresora.this, DeviceListActivity.class);
				startActivityForResult(serverIntent, REQUEST_CONNECT_DEVICE);
				break;
			}
			case R.id.Send_Button: {
				String msg = editText.getText().toString();
				String msg2 = "Prueba impresora Inversiones Santa Fe CombustiblesApp";
				if (msg2.length() > 0) {

						SendDataByte(PrinterCommand.POS_Print_Text(msg2, THAI, 255, 0, 0, 0));
						SendDataByte(Command.LF);

				} else {
					Toast.makeText(Impresora.this, getText(R.string.empty), Toast.LENGTH_SHORT).show();
				}
			}
			break;
		}
...
/****************************************************************************************************/
	...
	private void Print_Test(){
		String lang = getString(R.string.strLang);
  		if((lang.compareTo("en")) == 0){
			...
			String data = "Lograste la comunicacion entre el dispositivo movil y la impresora.\n";
	...
	private void GraphicalPrint(){
		...
		if(txt_msg.length() == 0){
			Toast.makeText(Impresora.this, getText(R.string.empty1), Toast.LENGTH_SHORT).show();
			return;
		}else{
	...
	private void CommandTest(){
		...
		String lang = getString(R.string.strLang);
		if((lang.compareTo("cn")) == 0){
		new AlertDialog.Builder(Impresora.this).setTitle(getText(R.string.chosecommand))
