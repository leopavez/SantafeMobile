...
public class Main_Activity extends Activity implements Runnable {
    ...
    public void imprimir(final String fecha, final String hora, final String patente, final String solicitud, final String obra,
                         final String asignados, final String cargados,
                         final String odometro, final String cargadopor, final String id_estatico, final String mascara) {
