                ...
                if (litroscargados.equals("") || odom.equals("")) {
                    ...
                    alertalistado.setPositiveButton("Aceptar", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialogInterface, int i) {
                            ...
                            SharedPreferences preferences1 = getSharedPreferences("impresora", Context.MODE_PRIVATE);
                            String mascara = preferences1.getString("mascara", "SIN MASCARA");
                            ...
                            String nombre = preferences.getString("nombre", "NO EXISTE DATO");
                            String apellido = preferences.getString("apellido", "NO EXISTE DATO");


                            String entregadopor = nombre + " " + apellido;
